                    ...
                    @foreach ([['Pending', $pendingIn, 'orange'], ['Approved', $approvedIn, 'teal'], ['Total', $totalIn, 'blue']] as [$label, $val, $color])
                        <div class="bg-{{ $color }}-50 dark:bg-gray-600 rounded-lg p-3">
                            <p class="text-sm text-{{ $color }}-600 dark:text-{{ $color }}-300">
                                {{ $label }}</p>
                            <p class="text-xl font-bold text-{{ $color }}-600 dark:text-{{ $color }}-300">
                                {{ $val }}</p>
                        </div>
                    @endforeach
                </div>
        ...
        <div class="flex justify-between items-start mb-5">
            <div class="w-full">
                ...
                <div class="flex justify-between space-x-4">
                    <!-- Pendapatan -->
                    <div class="w-1/3">
                        <span class="text-2xl font-bold text-green-700 dark:text-white pb-2">
                    ...
                    <!-- Pengeluaran -->
                    <div class="w-1/3">
                        <span class="text-2xl font-bold text-red-700 dark:text-white pb-2">
                    ...
                    <div class="w-1/3">
                        <span
                            class="text-2xl font-bold pb-2 @if ($totalKeuntungan < 0) text-red-600 @else text-green-600 @endif">
                ...
                <!-- Berdasarkan Type -->
                <p class="text-base font-normal text-gray-500 dark:text-gray-400 mt-2">Berdasarkan Type</p>
            </div>

            <!-- Dropdown for Chart Range -->
