        ...
        <label for="logo-upload" class="cursor-pointer group">
            @if ($company->logo)
                <img src="{{ asset('storage/company/' . $company->logo) }}"
                    class="mx-auto w-32 h-32 rounded-full object-cover shadow-md group-hover:opacity-80 transition" />
            @else
                <div
                    class="mx-auto w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center shadow-md group-hover:opacity-80 transition">
