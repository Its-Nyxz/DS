...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @php
            ...
            // Cek apakah ada background, jika tidak gunakan default
               $backgrounds = $company->backgrounds->map(function ($background) {
    ...
    <body id="background-carousel" class="bg-[#FDFDFC] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-sm w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:text-[#0c0c0c] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
                    <div class="text-center">
                        ...
                        <div class="mt-6 space-y-2 text-sm text-gray-700 dark:text-gray-400">
                            ...
                            @if ($company->email)
                                <p>
                                    ✉️ <a href="mailto:{{ $company->email }}" class="underline hover:text-blue-600 dark:hover:text-blue-400">
                                        {{ $company->email }}
                                    </a>
                                </p>
                            @endif
                ...
                <div
                    ...
                    x-data="{ active: 0, total: {{ $company->banners->count() }} }"
